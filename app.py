...
with gr.Blocks() as parent:
    ...
    with gr.Column():
        ChatInterface(
            ...
            theme="base",
            examples = [
                ["text", "Describe the trend of the mortality rates for children before age 5"],
                ["text", "What is the share of respondants who prefer Facebook Messenger in the 30-59 age group?"]
            ],
